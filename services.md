...
- [Soldering](#soldering)
  ...
  - [How to use the soldering room](#how-to-use-the-soldering-room)
- [3D Printing](#3d-printing)
  - [Learn the basics of 3D printing](#learn-the-basics-of-3d-printing)
  - [CAD Modeling](#cad-modeling)
- [Services for non-designers](#services-for-non-designers)
  - [User Research](#user-research)
  - [Design Process Education](#design-process-education)
...
3. Read the section [How to use the soldering room](#how-to-use-the-soldering-room), so that you already know how to use the soldering room when a TA gives you access to it!

### Learn to solder

SparkFun has this [thorough written guide on soldering through-hole components](https://learn.sparkfun.com/tutorials/how-to-solder-through-hole-soldering/all) (which are the majority of the soldering you will have to do in IOIO). If you prefer video instructions, refer to [this video by SparkFun](https://www.youtube.com/watch?v=f95i88OSWB4) instead.
...
https://www.instructables.com/3D-Printing-Basics/
...
You who is a student have access to a [free license to Autodesk Fusion 360](https://www.autodesk.com/education/edu-software/fusion), with which you can model their ideas and make them ready for 3D Printing. If you haven't used Fusion 360 before, check out [this tutorial on YouTube](https://www.youtube.com/watch?v=Izh99EnGLGw).

> [!NOTE]
> Fusion works surprisingly well with a trackpad (at least on a Mac) but it's best if you use a mouse while modelling in CAD. IOIO has some wired mice in the storage room.
...
Example case: [Agnes and Eszti's work with Tiago](https://docs.google.com/document/d/1QMKG4lYf3VNhi8xIgnVdwJ5lNJ5gR9adxqTc_57quVg/edit?usp=sharing)
...
Example case: [Workshop for Graphic Designers](https://github.com/I-O-I-O/.github-private/tree/eecd61cd06535fce027205042d3a17877e5451bc/assets/GB_IxD_workshop)
